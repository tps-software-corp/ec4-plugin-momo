...
class PluginManager extends AbstractPluginManager
{
    ...
    protected function setupPayment()
    {
        ...
        $Payment = $paymentRepository->findOneBy(['method_class' => MomoPaymentMethod::class]);
        if ($Payment instanceof Payment) {
            ...
            $Payment->setMethod('Ví điện tử MOMO');
            $Payment->setMethodClass(MomoPaymentMethod::class);
        }
    ...
    protected function removePayment()
    {
        ...
        $Payments = $paymentRepository->findBy(['method_class' => [MomoPaymentMethod::class]]);
